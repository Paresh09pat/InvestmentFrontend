...
const WithdrawalHistory = () => {
  ...
  const stats = {
    ...
    pendingWithdrawals: filteredTransactions.filter((t) => t.status === "pending")
      .length,
    completedWithdrawals: filteredTransactions.filter(
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            View all withdrawal transaction history
          </p>
        </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              ...
              dateFilter !== "all"
                ...
                : "No withdrawal transactions have been recorded yet."}
            </p>
          </div>
        )}
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between mt-6">
            <div className="text-sm text-gray-600">
              ...
              {filteredTransactions.length} withdrawal transactions
            </div>
