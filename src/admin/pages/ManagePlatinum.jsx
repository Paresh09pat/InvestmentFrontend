...
import { FiZap, FiPlus, FiSearch, FiFilter, FiEdit, FiTrash2, FiEye } from 'react-icons/fi';
    ...
    >
      ...
      <motion.div variants={itemVariants} className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Manage Platinum</h1>
            <p className="text-gray-600">Manage platinum investment packages and VIP services</p>
          </div>
        </div>
        <button className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-4 py-2 rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-200 flex items-center space-x-2 cursor-pointer">
      ...
      <motion.div variants={itemVariants} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              type="text"
              placeholder="Search platinum packages..."
              ...
              <tr>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 flex items-center justify-center text-white font-semibold">
                      P1
                    </div>
                    <div className="ml-4">
                      <div className="text-sm font-medium text-gray-900">Platinum Elite</div>
                      <div className="text-sm text-gray-500">VIP investment package</div>
                    </div>
                  </div>
                </td>
      ...
      <motion.div variants={itemVariants} className="text-center py-12">
        <div className="bg-gray-100 p-8 rounded-lg">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Platinum Package Management</h3>
          <p className="text-gray-600 mb-4">This page will contain platinum investment package management functionality.</p>
          <p className="text-sm text-gray-500">Features coming soon: Create, edit, view, and manage platinum investment packages and VIP services.</p>
        </div>
      </motion.div>
    </motion.div>
  );
