...
const Hero = () => {
  ...
  const solarSystemScale = useTransform(scrollYProgress, [0, 0.5, 1], [1, 0.8, 0.6]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      >
        ...
        />
        <defs>
          <linearGradient id="threadGradient2" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center w-full">
          ...
          >
            ...
            <motion.div
              ...
              className="flex flex-col cursor-pointer sm:flex-row flex-wrap gap-3 sm:gap-4"
            >
              <Link to="/login"> 
                  ...
                  {[45, 135, 225, 315].map((angle, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        transition={{
                          opacity: { duration: 1.8 + i * 0.4, repeat: Infinity },
                  ...
                  {[0, 120, 240].map((angle, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        transition={{
                          opacity: { duration: 1.5 + i * 0.3, repeat: Infinity },
                  ...
                  {[60, 180, 300].map((angle, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        transition={{
                          opacity: { duration: 1.2 + i * 0.2, repeat: Infinity },
