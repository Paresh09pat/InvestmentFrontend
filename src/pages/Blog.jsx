  ...
  const upcomingPosts = [
    {
      ...
      description: "Learn the fundamentals of smart investing and how to build your first portfolio",
      category: "Education",
    ...
    },
    {
      ...
      description: "Our expert analysis of market trends and investment opportunities",
    ...
    },
    {
      ...
      description: "How to protect your investments and personal information online",
      category: "Security",
    ...
    },
    {
      ...
      description: "Exploring emerging technologies and their impact on investment strategies",
      category: "Technology",
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <FiPenTool className="h-8 w-8 text-yellow-400" />
          ...
          >
            We're crafting 
            <span className="text-white font-semibold"> valuable content</span> to help you 
            become a smarter investor. Coming soon!
          </motion.p>
        </div>
      </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            >
              ...
              >
                <FiPenTool className="h-12 w-12 text-yellow-400" />
              </motion.div>
            ...
            >
              Our content team is working hard to create insightful articles, market analysis, 
              and educational resources that will help you make better investment decisions.
            </motion.p>
            <motion.div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Exciting articles we're working on for you
            </p>
          </motion.div>
            ...
            {upcomingPosts.map((post, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <motion.div 
                    className={`w-16 h-16 bg-gradient-to-r ${post.color} rounded-xl flex items-center justify-center flex-shrink-0`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <motion.p 
              ...
              transition={{ delay: 0.4, duration: 0.8 }}
            >
              Be the first to read our latest articles and market insights!
            </motion.p>
            <motion.div 
